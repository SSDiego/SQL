...
/* Inner join with using When joining tables with a common field name, e.g. */
...
/* Keep the first query intact that creates pop_plus using INTO. Write a query to join countries_plus AS c on the left with pop_plus
AS p on the right matching on the country code fields. Sort the data based on geosize_group, in ascending order so that large appears
on top. Select the name, continent, geosize_group, and popsize_group fields. */
--------------------------------------------------------------------------------------------------------------------------------------
